...
Fun, interactive AI / generative-art experiments I built.

<div class="playground-grid">
  <a class="playground-card" href="playground/suminagashi.html" target="_blank" rel="noopener">
    <span class="playground-icon">🌊</span>
    <span class="playground-name">Suminagashi</span>
  ...
  <a class="playground-card" href="playground/contact-glass-all-liquid-fallback-texture.html" target="_blank" rel="noopener">
    <span class="playground-icon">🫧</span>
    <span class="playground-name">Liquid Glass</span>
    <span class="playground-desc">A liquid-glass UI showcase — glassmorphism components and effects you can use as a starting point for designing glass-themed websites.</span>
    <span class="playground-go">Try it →</span>
  </a>
</div>
