# 🔥 News
- [***2026.05***] We release the **[Extreme Driving Dataset](https://sean-shiyuez.github.io/extreme-driving-dataset-web/)**, a multi-modal driving dataset providing rich chassis dynamics (raw IMU and GPS heading) for limit-handling research and VLA model training. It covers 6 scenario categories: Normal, Complex Traffic, Critical, Low Light, Rain, and Snow.
  - **Project Page:** [sean-shiyuez.github.io/extreme-driving-dataset-web](https://sean-shiyuez.github.io/extreme-driving-dataset-web/)
  - **Dataset:** [Hugging Face — Stary108/Extreme\_Driving\_Conditions\_Dataset](https://huggingface.co/datasets/Stary108/Extreme_Driving_Conditions_Dataset)
